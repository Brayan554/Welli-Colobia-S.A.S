  ...
  <body>
    ...
    <div class="container-login100" >
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
        <form action="?controller=usuario&method=create" method="post" class="login100-form validate-form">
          ...
          <div class="wrap-input100 validate-input m-b-23" data-validate = "Ingresar Email">
            ...
            <input class="input100" type="text" name="nombreuser" placeholder="Nombre Completo">
            <span class="focus-input100" data-symbol="&#xf206;"  ></span>
          </div>
          <div class="wrap-input100 validate-input m-b-23" data-validate = "Ingresar Email">

            <span class="label-input100">Email</span>
            <input class="input100" type="email" name="emailuser" placeholder="@gmail.com">
            <span class="focus-input100" data-symbol="&#xf206;"  ></span>
          </div>
