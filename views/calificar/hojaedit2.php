...
<form action="?controller=calificar&method=update"  method="post" onsubmit="return validarCandidato();" id="wizard">
  ...
  <div class="wrapper-mid">
    ...
    <div id="paper">
      ...
      >
            ...
            <input type="text"  id="porcentajePuntuacion" name="porcentajePuntuacion"
                value="<?php echo $data[0]->porcentajePuntuacion?>"  
                 class="form-control" placeholder="nombre Referencia Laboral" 
              >
        ...
        <div class="entry">
          <h2>Calificar</h2>
          <p>En Esta Seccion usted como funcionario de contratacion debera  responder una serie de preguntas las cuales van a definir la puntiacion del candidato a aplicar</p>
          ...
          <div class="content">
            ...
            <li>¿El candidato Cumple con mas de 2 años de Experiencia?
            ...
            <li>¿El candidato Cumple con estudios Basicos?
            <select  id="op2" class="form-control">
            <option value="1">si
              </option>
              <option value="2">no
              </option>
            ...
            <li>¿El candidato Cumple con estudios Segundario(Tecnico,Tecnologo)?
            <select  id="op3" class="form-control">
            <option value="1">si
              </option>
              <option value="2">no
              </option>
            ...
            <li>¿El candidato Tiene estudios Superiores?
            <select  id="op4" class="form-control">
            <option value="1">si
              </option>
              <option value="2">no
              </option>
            ...
            <li>¿El candidato Tiene estudios Superiores que se relacionen con la oferta a Aplicar?
            <select  id="op5" class="form-control ">
            <option value="1">si
              </option>
              <option value="2">no
              </option>
            ...
            <li>
            <button class="text-center" id="hola">Calificar</button>
            </li>
