      ...
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
        <form action="?controller=login&method=login" method="post" class="login100-form validate-form">
          ...
          <div class="wrap-input100 validate-input m-b-23" data-validate = "Ingresar Email">
            ...
            <input class="input100" type="email" name="email" placeholder="@gmail.com">
            <span class="focus-input100" data-symbol="&#xf206;" value="<?php echo isset($error['email']) ? $error['email'] : '' ?>" ></span>
          </div>

          <div  class="wrap-input100 validate-input" data-validate="Ingresar Contraseña">
            <span class="label-input100">Password<i class=" fa fa-eye" id="show"></i></span>

            <input id="contrasena"  class="input100" type="password" name="contrasena" placeholder="*****">
            <span class="focus-input100" data-symbol="&#xf190;"></span>
          </div>
          
          <div class="text-right p-t-4 p-b-31">
            <a href="?controller=aplicar&method=crear">
             Crear Cuenta
            </a>
          </div>
             
          <div class="text-right p-t-4 p-b-31">
            <a href="?controller=aplicar&method=olvidar">
