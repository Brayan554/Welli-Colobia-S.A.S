...
<?php
    if ($_SESSION['user']->idcargo == 1 ||$_SESSION['user']->idcargo == 2 || $_SESSION['user']->idcargo == 4) {
...
?>
	...
	<table id="data" class="display responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            ?>
            	<td>
		      			<a href="?controller=oferta&method=updateStatus&idOferta=<?php echo $oferta->idOferta?>" class="btn btn-danger"><i class="fas fa-plus-circle"></i>off</a>
		      		</td>
            <?php
            ...
            ?>
              <td>
		      			<a href="?controller=oferta&method=updateStatus&idOferta=<?php echo $oferta->idOferta?>" class="btn btn-primary"><i class="fas fa-plus-circle"></i>on</a>
		      		</td>
            <?php
              }
            ?>
			    ...
			    <tr>
			      ...
			      <td><?php echo $oferta->nombreEstado?></td>
			    	...
			    	<td>
						...
						<button  class="btn btn-danger" onclick="ventanaSecundaria('http://localhost/NuevoWelli/?controller=candidato&method=new')">Aplicar <i class="fa fa-print" aria-hidden="true"></i></button>
