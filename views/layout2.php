        ...
        <div class="menu-sidebar__content js-scrollbar1">
          <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
              ...
              <li>
                <a href="?controller=Certificacion">
                <i class="fa fa-file-pdf-o" aria-hidden="true"></i>Certificaciones</a
                >
              </li>
              <li>
                <a href="?controller=calificar">
                <i class="fa fa-check" aria-hidden="true"></i>Calificaciones</a
                >
              </li>
              <li>
...
<div class="noti__item js-item-menu">
  ...
  <span class="quantity"><?php echo count($notificaciones) ?></span>
  ...
  <div class="notifi__title">
    ...
    <?php foreach ($notificaciones as $noti) : ?>
      <p>Nuevas Notificaciones:
        <?php echo $noti->nombreOferta?>
      </p>
    <?php endforeach?> 
    </div>
    <?php foreach ($notificaciones as $noti) : ?>
    <div class="notifi__item">
      ...
      <div class="content">
        ...
        <p>Nueva Oferta: <?php echo $noti->nombreOferta?></p>
        <span class="date">Inicio: <?php echo $noti->FechaInicial?> Hasta : <?php echo $noti->FechaLimite?> </span>
      </div>

      <a href="?controller=oferta&method=deleteNotificacion&idOferta=<?php echo $noti->idOferta ?>" ><span class="icon-times "><i class="fa fa-trash" aria-hidden="true"></i></a>
                    ...
                    <div class="account-item clearfix js-item-menu">
                      ...
                      <div class="account-dropdown js-dropdown">
                        ...
                        <div class="account-dropdown__body">
                          ...
                          <div class="account-dropdown__item">
                            <a href="#">
                              <i class="zmdi zmdi-settings"></i>Cambiar Contraseña</a
                            >
                          </div>
                          <div class="account-dropdown__item">
                            <a href="#">
                    ...
                    <div class="account-item clearfix js-item-menu">
                      ...
                      <div class="account-dropdown js-dropdown">
                        ...
                        <div class="account-dropdown__body">
                          ...
                          <div class="account-dropdown__item">
                            <a href="?controller=usuario&method=show">
                              <i class="zmdi zmdi-settings"></i>Cambiar Contraseña</a
                            >
                          </div>
                          <div class="account-dropdown__item">
